...
using TodoApp.Web.WebAPI.App_Start;
using TodoApp.Web.WebAPI.Providers;
...
namespace TodoApp.Web.WebAPI
{
    ...
    getUserIdCallback: id => id.GetUserId<int>())
            ...
            OAuthOptions = new OAuthAuthorizationServerOptions
            {
                ...
                AuthorizeEndpointPath = new PathString("/api/MobileUser/ExternalLogin"),
            ...
            CheckSystemAdminUsers.CheckSystemDefaultUser();
        }
    }
}